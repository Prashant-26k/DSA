...
| **Link** | [View Problem](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) |
| **Runtime** | 6 ms |
| **Memory** | 47.4 MB |

## Approach

Just like LCA in Binary tree question we check for null first then for p and q .

if p and q values are small then only call left recursive call and set right to null, other wise if both greater value than vice versa.

in the end the same logic to return root if both non null and right if only right non null and vice versa.
...
**Author**: [@ramona_crg](https://leetcode.com/ramona_crg/)
**Upvotes**: 60 👍
**Link**: [View Original Post](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/solutions/64955/)
