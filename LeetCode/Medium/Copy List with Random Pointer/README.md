...
use hashMap to store node to node value and then copy the entire list in hashmap (key = curr, value = new Node(curr.val)).

Now looping again to coonect next and random pointers. 
