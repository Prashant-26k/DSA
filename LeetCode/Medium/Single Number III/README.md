...
| **Link** | [View Problem](https://leetcode.com/problems/single-number-iii/) |
| **Runtime** | 1 ms |
| **Memory** | 48.3 MB |

## Approach

Xor all the numbers then the using and of xor with -xor to find last set bit and then looping through thge array to check if last bit is 0 or 1 and accordingly updating ans array.
...
**Title**: 🔥🔥 DEMON Level Explanation || 3 Approaches 😨😱🤯
**Author**: [@hi-malik](https://leetcode.com/hi-malik/)
**Upvotes**: 224 👍
**Link**: [View Original Post](https://leetcode.com/problems/single-number-iii/solutions/5233206/)
...
![image](https://assets.leetcode.com/users/images/3271183a-0386-40e8-a717-b9766d08366a_1717121775.8704052.png)
