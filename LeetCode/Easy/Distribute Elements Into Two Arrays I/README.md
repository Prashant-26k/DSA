...
make two arrays and initialize the first values in both, then make two pointers for both arrays and starting from 2 to size range we compare the last elements  of both arrays and update the values .

at the end update the first array by the elements of second.
